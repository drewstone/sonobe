...
fn main() {
    ...
    let r1cs_path = PathBuf::from(
        "./folding-schemes/src/frontend/circom/test_folder/external_inputs_nested.r1cs",
    );
    let wasm_path = PathBuf::from(
        "./folding-schemes/src/frontend/circom/test_folder/external_inputs_nested_js/external_inputs_nested.wasm",
    );
